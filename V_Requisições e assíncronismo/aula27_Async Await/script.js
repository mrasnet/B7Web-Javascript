...
/* Definimos a função como async - assíncrona - para que instruções fora dessa função não tenham que esperar o termino da execução dessa função
...
async function requisitar2(){
    ...
    //Aqui roda o fecth e vai ficar esperando a resposta, não passa para a próxima instrução
