/*---------------------( M3: Aula #25: Promise  )------------------------------------------------------------
   Se utiliza quando se precisa de uma "promeça" - mensagem de garantia de que tal processo (que apresenta demora na resposta) vai retornar algo.
...
*/
function fazer(){
    //dentro do promise é necessário mandar uma função com os parametros: resolve / reject - ambas são funções
    let promise = new Promise((resolve, reject) => {
        
        setTimeout(()=>{//setTimeout para simular uma espera

            //outros comandos**** requisição a banco de dados, webservices etc.
            resolve('OK'); //resposta 
...
//Quem executar a função 'fazer' saberá imediatamente que vai receber uma promeça - que em determinado momento receberá um resposta dessa promeça
